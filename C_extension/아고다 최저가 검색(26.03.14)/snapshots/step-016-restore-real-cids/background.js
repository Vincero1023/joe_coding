...
const SCENARIO_TIMEOUT_MS = 6500;
const SCAN_PAGE_READY_TIMEOUT_MS = 4200;
const SCAN_POST_READY_DELAY_MS = 400;
...
async function navigateScanTab(tabId, targetUrl, timeoutMs, scanContext) {
  ...
  await new Promise((resolve, reject) => {
    ...
    const timeoutHandle = setTimeout(() => {
      ...
      fail(new Error(`Timed out waiting for Agoda page DOM readiness.${suffix}`));
    }, timeoutMs);
