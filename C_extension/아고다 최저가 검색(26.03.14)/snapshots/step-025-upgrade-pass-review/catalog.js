...
const AGODA_CATALOG = {
  traffic: [
    ...
    ,
    {
      id: "random-cid-1681254",
      label: "Random CID 1681254",
      group: "traffic",
      groupLabel: "Traffic / Experimental",
      cid: "1681254",
      description: "Experimental CID rule from user-provided Agoda link set"
    },
    {
      id: "random-cid-1694831",
      label: "Random CID 1694831",
      group: "traffic",
      groupLabel: "Traffic / Experimental",
      cid: "1694831",
      description: "Experimental CID rule from user-provided Agoda link set"
    ...
    {
      id: "random-cid-1773583",
      label: "Random CID 1773583",
      group: "traffic",
      groupLabel: "Traffic / Experimental",
      cid: "1773583",
      description: "Experimental CID rule from user-provided Agoda link set"
...
const AGODA_HIGH_PRIORITY_IDS = new Set([
  "bc-card",
  "kb-card",
  "mastercard",
  "visa",
...
for (const entry of [
  ...
  ...AGODA_CATALOG.cards,
  ...AGODA_CATALOG.airlines,
  ...AGODA_CATALOG.promos
]) {
  entry.priority = entry.mode === "promo-page"
    ? "normal"
    : (AGODA_HIGH_PRIORITY_IDS.has(entry.id) ? "high" : "normal");
}
