...
function loadProfileData() {
  ...
  if (document.getElementById("blockEnabled")) document.getElementById("blockEnabled").checked = !!settings.blockEnabled;
...
async function saveOptions(skipAlert) {
  ...
  const settings = {
    ...
    blockEnabled: document.getElementById("blockEnabled") ? document.getElementById("blockEnabled").checked : false,
